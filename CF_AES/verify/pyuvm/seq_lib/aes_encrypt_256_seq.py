"""AES-256 encryption sequence — uses NIST test vector."""
...
class aes_encrypt_256_seq(uvm_sequence):
    async def body(self):
        ...
        # Write full 256-bit key into KEY0-KEY7
        key = NIST_KEY_256
        for i in range(8):
        ...
        # CTRL: encdec=1 (encrypt), keylen=1 (256-bit), init=1
        ctrl = (1 << 2) | (1 << 3) | (1 << 0)
