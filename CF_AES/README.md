...
[![Verification](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_AES/gh-pages/badges/verification.json)](https://github.com/chipfoundry/CF_AES/actions)
[![Functional Coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_AES/gh-pages/badges/func-coverage.json)](https://github.com/chipfoundry/CF_AES/actions)
[![Line Coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_AES/gh-pages/badges/line-coverage.json)](https://github.com/chipfoundry/CF_AES/actions)
[![Branch Coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_AES/gh-pages/badges/branch-coverage.json)](https://github.com/chipfoundry/CF_AES/actions)
...
The following table is the result for implementing the CF_AES IP with different wrappers using Sky130 HD library and [OpenLane2](https://github.com/efabless/openlane2) flow.
...
```
## Firmware Drivers:
Firmware drivers for CF_AES can be found in the [Drivers](https://github.com/efabless/EFIS/tree/main/Drivers) directory in the [EFIS](https://github.com/efabless/EFIS) (Efabless Firmware Interface Standard) repo. CF_AES driver documentation  is available [here](https://github.com/efabless/EFIS/blob/main/Drivers/Docs/CF_AES/README.md).
You can also find an example C application using the CF_AES drivers [here](https://github.com/efabless/EFIS/tree/main/Drivers/Docs/CF_AES/example).
## Installation:
...
- After installing IPM, execute the following command ```ipm install CF_AES```.
...
```git clone github.com/chipfoundry/CF_AES```
...
<img src="docs/_static/CF_AES.svg" width="600"/>
