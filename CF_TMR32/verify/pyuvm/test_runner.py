#!/usr/bin/env python3
"""Test runner for CF_TMR32 — uses cocotb.runner API."""
...
IP_NAME = "CF_TMR32"
YAML_FILE = str(PROJ_PATH / "../../CF_TMR32.yaml")

BUSES = ["APB", "AHB", "WISHBONE"]
BUS_CONFIGS = {
    "APB": {
        "design_name": "CF_TMR32_APB",
        "clk": "PCLK",
        "rst": "PRESETn",
        "macro": "BUS_TYPE_APB",
    },
    "AHB": {
        "design_name": "CF_TMR32_AHBL",
        "clk": "HCLK",
        "rst": "HRESETn",
        "macro": "BUS_TYPE_AHB",
    },
    "WISHBONE": {
        "design_name": "CF_TMR32_WB",
        "clk": "clk_i",
        "rst": "rst_i",
...
def get_rtl_sources():
    ...
    sources.append(str(rtl_dir / "CF_TMR32.v"))

    wrapper_dir = rtl_dir / "bus_wrappers"
    for name in ("CF_TMR32_APB.v", "CF_TMR32_AHBL.v", "CF_TMR32_WB.v"):
...
def _fallback_reports(out_dir, results_list):
    ...
    md_lines.append("")
    md_lines.append("# CF_TMR32 Verification Results")
    md_lines.append("")
