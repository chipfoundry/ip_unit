#!/usr/bin/env python3
"""Test runner for CF_QSPI_XIP_CTRL — uses cocotb.runner API."""
...
IP_NAME = "CF_QSPI_XIP_CTRL"
YAML_FILE = str(PROJ_PATH / "../../CF_QSPI_XIP_CTRL.yaml")

BUSES = ["AHB"]
BUS_CONFIGS = {
    "AHB": {
        "design_name": "CF_QSPI_XIP_CTRL_AHBL",
        "clk": "HCLK",
        "rst": "HRESETn",
        "macro": "BUS_TYPE_AHB",
    },
...
def get_rtl_sources():
    ...
    vip_dir = PROJ_PATH / "../../verify/vip"
    sources = []

    sources.append(str(rtl_dir / "CF_QSPI_XIP_CTRL.v"))
    sources.append(str(rtl_dir / "DMC.v"))

    wrapper_dir = rtl_dir / "bus_wrappers"
    sources.append(str(wrapper_dir / "CF_QSPI_XIP_CTRL_AHBL.v"))

    sources.append(str(vip_dir / "sst26wf080b.v"))
