...
The following table is the result for implementing the CF_QSPI_XIP_CTRL IP with different wrappers using Sky130 HD library and [OpenLane2](https://github.com/efabless/openlane2) flow.
|Module | Number of cells | Max. freq |
|---|---|---|
|CF_QSPI_XIP_CTRL|1973| 250 |
|CF_QSPI_XIP_CTRL_AHBL|1973|250|
...
- After installing IPM, execute the following command ```ipm install CF_QSPI_XIP_CTRL```.
...
```git clone github.com/chipfoundry/CF_QSPI_XIP_CTRL```
...
<img src="docs/_static/CF_QSPI_XIP_CTRL.svg" width="600"/>
