...
|                | Name           |
| -------------- | -------------- |
| int | **[CF_GPIO8_readData](Files/EF__GPIO8_8h.md#function-ef-gpio8-readdata)**(uint32_t gpio_base)<br>reads the input value of the GPIOs  |
| void | **[CF_GPIO8_waitInput](Files/EF__GPIO8_8h.md#function-ef-gpio8-waitinput)**(uint32_t gpio_base, int data)<br>wait until the input GPIOs have a certain value  |
| void | **[CF_GPIO8_wait_InputPin](Files/EF__GPIO8_8h.md#function-ef-gpio8-wait-inputpin)**(uint32_t gpio_base, int pin, int data)<br>wait until a GPIO pin have a certain value  |
| void | **[CF_GPIO8_writeData](Files/EF__GPIO8_8h.md#function-ef-gpio8-writedata)**(uint32_t gpio_base, int data)<br>drives the output value of the GPIOs  |
| void | **[CF_GPIO8_writeAllDirection](Files/EF__GPIO8_8h.md#function-ef-gpio8-writealldirection)**(uint32_t gpio_base, int data)<br>sets the direction of all GPIOs  |
| int | **[CF_GPIO8_readDirection](Files/EF__GPIO8_8h.md#function-ef-gpio8-readdirection)**(uint32_t gpio_base)<br>gets the direction of all GPIOs  |
| void | **[CF_GPIO8_setPinDirection](Files/EF__GPIO8_8h.md#function-ef-gpio8-setpindirection)**(uint32_t gpio_base, int pin, int dir)<br>sets the direction of one GPIO pin  |
| int | **[CF_GPIO8_getRIS](Files/EF__GPIO8_8h.md#function-ef-gpio8-getris)**(uint32_t gpio_base) |
| int | **[CF_GPIO8_getMIS](Files/EF__GPIO8_8h.md#function-ef-gpio8-getmis)**(uint32_t gpio_base) |
| void | **[CF_GPIO8_setIM](Files/EF__GPIO8_8h.md#function-ef-gpio8-setim)**(uint32_t gpio_base, int mask) |
| int | **[CF_GPIO8_getIM](Files/EF__GPIO8_8h.md#function-ef-gpio8-getim)**(uint32_t gpio_base) |
| void | **[CF_GPIO8_setICR](Files/EF__GPIO8_8h.md#function-ef-gpio8-seticr)**(uint32_t gpio_base, int mask) |
