...
|                | Name           |
| -------------- | -------------- |
| int | **[CF_GPIO8_readData](Files/EF__GPIO8_8c.md#function-ef-gpio8-readdata)**(uint32_t gpio_base)<br>reads the input value of the GPIOs  |
| void | **[CF_GPIO8_waitInput](Files/EF__GPIO8_8c.md#function-ef-gpio8-waitinput)**(uint32_t gpio_base, int data)<br>wait until the input GPIOs have a certain value  |
| void | **[CF_GPIO8_wait_InputPin](Files/EF__GPIO8_8c.md#function-ef-gpio8-wait-inputpin)**(uint32_t gpio_base, int pin, int data)<br>wait until a GPIO pin have a certain value  |
| void | **[CF_GPIO8_writeData](Files/EF__GPIO8_8c.md#function-ef-gpio8-writedata)**(uint32_t gpio_base, int data)<br>drives the output value of the GPIOs  |
| void | **[CF_GPIO8_writeAllDirection](Files/EF__GPIO8_8c.md#function-ef-gpio8-writealldirection)**(uint32_t gpio_base, int data)<br>sets the direction of all GPIOs  |
| int | **[CF_GPIO8_readDirection](Files/EF__GPIO8_8c.md#function-ef-gpio8-readdirection)**(uint32_t gpio_base)<br>gets the direction of all GPIOs  |
| void | **[CF_GPIO8_setPinDirection](Files/EF__GPIO8_8c.md#function-ef-gpio8-setpindirection)**(uint32_t gpio_base, int pin, int dir)<br>sets the direction of one GPIO pin  |
| void | **[CF_GPIO8_setIM](Files/EF__GPIO8_8c.md#function-ef-gpio8-setim)**(uint32_t gpio_base, int mask) |
| int | **[CF_GPIO8_getRIS](Files/EF__GPIO8_8c.md#function-ef-gpio8-getris)**(uint32_t gpio_base) |
| int | **[CF_GPIO8_getMIS](Files/EF__GPIO8_8c.md#function-ef-gpio8-getmis)**(uint32_t gpio_base) |
| int | **[CF_GPIO8_getIM](Files/EF__GPIO8_8c.md#function-ef-gpio8-getim)**(uint32_t gpio_base) |
| void | **[CF_GPIO8_setICR](Files/EF__GPIO8_8c.md#function-ef-gpio8-seticr)**(uint32_t gpio_base, int mask) |

## Defines

|                | Name           |
| -------------- | -------------- |
|  | **[CF_GPIO8_C](Files/EF__GPIO8_8c.md#define-ef-gpio8-c)**  |


## Functions Documentation

### function CF_GPIO8_readData

```cpp
int CF_GPIO8_readData(
    uint32_t gpio_base
)
```
...
### function CF_GPIO8_waitInput

```cpp
void CF_GPIO8_waitInput(
    uint32_t gpio_base,
    int data
)
```
...
### function CF_GPIO8_wait_InputPin

```cpp
void CF_GPIO8_wait_InputPin(
    uint32_t gpio_base,
    int pin,
    int data
)
...
### function CF_GPIO8_writeData

```cpp
void CF_GPIO8_writeData(
    uint32_t gpio_base,
    int data
)
```
...
### function CF_GPIO8_writeAllDirection

```cpp
void CF_GPIO8_writeAllDirection(
    uint32_t gpio_base,
    int data
)
```
...
### function CF_GPIO8_readDirection

```cpp
int CF_GPIO8_readDirection(
    uint32_t gpio_base
)
```
...
### function CF_GPIO8_setPinDirection

```cpp
void CF_GPIO8_setPinDirection(
    uint32_t gpio_base,
    int pin,
    int dir
)
...
### function CF_GPIO8_setICR

```cpp
void CF_GPIO8_setICR(
    uint32_t gpio_base,
    int mask
)
```
...
int CF_GPIO8_readData(uint32_t gpio_base){
    CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
    return (gpio->DATAI);
}

void CF_GPIO8_waitInput(uint32_t gpio_base, int data){
     CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
    while (EF_GPIO_readData(gpio_base) != data);
}

void CF_GPIO8_wait_InputPin(uint32_t gpio_base, int pin, int data){
    CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
...
void CF_GPIO8_writeData(uint32_t gpio_base, int data){
    
    CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
    gpio->DATAO = data;
}

void CF_GPIO8_writeAllDirection(uint32_t gpio_base, int data){
...
int CF_GPIO8_readDirection(uint32_t gpio_base){
...
void CF_GPIO8_setPinDirection(uint32_t gpio_base, int pin, int dir){
...
void CF_GPIO8_setIM(uint32_t gpio_base, int data){
...
int CF_GPIO8_getRIS(uint32_t gpio_base){

    CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
    return (gpio->ris);
}

int CF_GPIO8_getMIS(uint32_t gpio_base){

    CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
    return (gpio->mis);
}

void CF_GPIO8_setIM(uint32_t gpio_base, int mask){
   
    CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
    gpio->im |= mask;
}

int CF_GPIO8_getIM(uint32_t gpio_base){

   CF_GPIO8_TYPE* gpio = (CF_GPIO8_TYPE*)gpio_base;
    return (gpio->im);
}

void CF_GPIO8_setICR(uint32_t gpio_base, int mask){
