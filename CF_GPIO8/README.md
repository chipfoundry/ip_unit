...
![Verification](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_GPIO8/gh-pages/badges/verification.json)
![Functional Coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_GPIO8/gh-pages/badges/func-coverage.json)
![Line Coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_GPIO8/gh-pages/badges/line-coverage.json)
![Branch Coverage](https://img.shields.io/endpoint?url=https://raw.githubusercontent.com/chipfoundry/CF_GPIO8/gh-pages/badges/branch-coverage.json)
...
The following table is the result for implementing the CF_GPIO8 IP with different wrappers using Sky130 HD library and [OpenLane2](https://github.com/efabless/openlane2) flow.
|Module | Number of cells | Max. freq |
|---|---|---|
|CF_GPIO8|72| 1666 |
|CF_GPIO8_APB|476|1250|
|CF_GPIO8_AHBL|493|294|
|CF_GPIO8_WB|574|588|
...
```
## Firmware Drivers:
Firmware drivers for CF_GPIO8 can be found in the [Drivers](https://github.com/efabless/EFIS/tree/main/Drivers) directory in the [EFIS](https://github.com/efabless/EFIS) (Efabless Firmware Interface Standard) repo. CF_GPIO8 driver documentation  is available [here](https://github.com/efabless/EFIS/blob/main/Drivers/Docs/CF_GPIO8/README.md).
You can also find an example C application using the CF_GPIO8 drivers [here](https://github.com/efabless/EFIS/tree/main/Drivers/Docs/CF_GPIO8/example).
## Installation:
...
- After installing IPM, execute the following command ```ipm install CF_GPIO8```.
...
```git clone github.com/efabless/CF_GPIO8```
...
<img src="docs/_static/CF_GPIO8.svg" width="600"/>
