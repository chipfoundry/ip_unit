#!/usr/bin/env python3
"""Test runner for CF_WDT32 — uses cocotb.runner API."""
...
IP_NAME = "CF_WDT32"
YAML_FILE = str(PROJ_PATH / "../../CF_WDT32.yaml")

BUSES = ["APB", "AHB", "WISHBONE"]
BUS_CONFIGS = {
    "APB": {
        "design_name": "CF_WDT32_APB",
        "clk": "PCLK",
        "rst": "PRESETn",
        "macro": "BUS_TYPE_APB",
    },
    "AHB": {
        "design_name": "CF_WDT32_AHBL",
        "clk": "HCLK",
        "rst": "HRESETn",
        "macro": "BUS_TYPE_AHB",
    },
    "WISHBONE": {
        "design_name": "CF_WDT32_WB",
        "clk": "clk_i",
        "rst": "rst_i",
...
def get_rtl_sources():
    ...
    sources.append(str(rtl_dir / "CF_WDT32.v"))

    wrapper_dir = rtl_dir / "bus_wrappers"
    for name in ("CF_WDT32_APB.v", "CF_WDT32_AHBL.v", "CF_WDT32_WB.v"):
...
def _fallback_reports(out_dir, results_list):
    ...
    md_lines.append("")
    md_lines.append("# CF_WDT32 Verification Results")
    md_lines.append("")
